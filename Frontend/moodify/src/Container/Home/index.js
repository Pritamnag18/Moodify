                    ...
                    <div className="row  flex-lg align-items-center">
                        <div className={`col-xl-5 col-lg-7 mt-2`} style={{ paddingLeft: '20px' }}>
                            ...
                            <div className="button-one mt-4 pt-3">  
                                <button className="Primary btn btn-dark rounded-5 d-flex align-items-center"><Link to={'/camera'} style={{textDecoration:"none",color: "rgb(204, 214, 246)"}}><IoCameraOutline size={28} style={{verticalAlign:'middle'}}/><span className="mx-2">OPEN YOUR CAMERA</span></Link></button>                               
                            </div>
